...
seq = iaa.Sequential([iaa.Resize({"height": 512, "width": 512}),
    iaa.Fliplr(0.5),
    iaa.Flipud(0.5),
    iaa.Multiply((0.5, 1.5)),
    iaa.Affine(
        scale={"x": (0.9, 1.1), "y": (0.9, 1.1)},rotate=(-20, 20),shear=(-16, 16)
    ),
    iaa.Sometimes(0.5,
...
class DataGenerator(keras.utils.Sequence):
    ...
    def __init__(self, image_paths, annot_paths, batch_size=1,
    ...
    def create_multi_masks(self, im, shape_dicts):
        ...
        if 'background' in cls:
            ...
            a3 = np.array( [[[0,0],[0,512],[512,512],[512,0]]], dtype=np.int32 )
    ...
    def augment_poly(self, im, shape_dicts):
        ...
        keypoints = ia.KeypointsOnImage(points, shape=(500,500,3))
